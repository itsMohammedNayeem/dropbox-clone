  ...
  return (
    <main className="">
      <div className="flex flex-col lg:flex-row items-center bg-[#1E1919] dark:bg-slate-800">
        <div className="p-10 flex flex-col bg-[#2B2929] dark:bg-slate-800 text-white space-y-5">
          <h1 className="text-5xl font-bold">
            ...
            <br />
            Storing everything you for and your business needs. All in one
            place.
          </h1>
          ...
          <p className="pb-20">
            ...
            energy to work. Enhance your personal storage with Dropbox, offering
            a simple and efficient to upload, organize, and access files from
            anywhere. Securely store important documents, photos, videos, and
            more with Dropbox and experience the cloud storage solution that
            makes it easy to access files from any device.
          </p>
      ...
      <p className="text-center font-light p-2">
        This is made for educational purposes only. I do not own any of the
